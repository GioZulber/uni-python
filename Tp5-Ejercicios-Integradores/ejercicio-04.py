...
Escribir un programa que lea el número del cliente y el total de la factura, y emita un informe donde cons-te el número del cliente y los tres importes que podría abonar según la fecha de pago.
'''